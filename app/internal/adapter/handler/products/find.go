...
func (u *productsHandler) FindProducts(c echo.Context) error {
	var req request.FindProducts
	var qry qryparam.FindProducts
	...
	data, err := u.service.FindProducts(c.Request().Context(), &req, &qry)
	if err != nil {
